a module that takes advantage of Android's demo mode, simulating network and signal
...
> **Note:** > 🇺🇸 Tests performed on a **Redmi 9A** using a hotspot connection from a **Redmi Note 12 Pro 5G** on the **5GHz band**.
...
| **Satellite (SOS)** | 60 Kbps | | **Satellite-Wi-Fi (My own creation)** | 1.73 Mbps | 
| **Starlink** | 20.8 Mbps |
